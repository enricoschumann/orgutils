...
R tools for handling Org (https://orgmode.org/) files
...
For [[https://orgmode.org/manual/Creating-timestamps.html][inactive timestamps]] set the argument =inactive= to =TRUE=.
